...
if (!function_exists("system_form_install_configure_form_alter")) {
  function system_form_install_configure_form_alter(&$form, $form_state) {
    $form['site_information']['site_name']['#default_value'] = 'Drupal Spur';

    // The name of the site, taken from the URL.

	$form['site_information']['site_name']['#default_value'] = ITOMIC_SITE_NAME;
	$form['site_information']['site_mail']['#default_value'] = 'webmaster@' . ITOMIC_SITE_NAME;

	// Set a default username and email address.
	$form['admin_account']['account']['name']['#default_value'] = 'admin';
	$form['admin_account']['account']['mail']['#default_value'] = 'me@domain.com';
